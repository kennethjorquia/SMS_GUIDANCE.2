...
<div class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Data</li>
          ...
          <h2>GROUP COUNSELING</h1>
          <div class="py-3"> 
          <button href="index.php" type="button" class="btn btn-primary text-light">Start Counceling</button>
          </div>
<div class="d-flex justify-content-between align-items-center">
            <div class="dropdown d-flex align-items-center">
              ...
              <button type="button" class="btn btn-primary  text-light ">Filter</button>
